...
static const char *CSS =
    ...
    "entry { background-color: rgba(255,255,255,0.7); color: #000000; border: 3px solid #000000;"
    "  border-radius: 0; padding: 6px 10px; font-size: 13px; min-height: 32px; }"
    "entry:focus { border-color: #000000; background-color: rgba(255,255,255,0.7); color: #000000; }"
